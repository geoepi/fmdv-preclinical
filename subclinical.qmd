...
Study-wide rates.  These estimates are the results from the [Incubation](https://geoepi.github.io/fmdv-preclinical/incubation.html) and [Latent](https://geoepi.github.io/fmdv-preclinical/latent.html) analyses.  
```{r} 
# from other analysis
...
Subclinical by group.  These estimates are the results from the [Incubation](https://geoepi.github.io/fmdv-preclinical/incubation.html) and [Latent](https://geoepi.github.io/fmdv-preclinical/latent.html) analyses.
```{r}
